...
export default function CallbackPromiseAsyncAwaitPage() {
  ...
  function onClickMyCallback() {
    // new Date() //날짜 기능을 가진 내장 객체
    const ccc = new XMLHttpRequest(); // XMLHttpRequest : js에 내장 되어 있는 객체
  ...
  return (
    <>
      ...
      <button onClick={onClickMyPromise}>Promise요청하기 !</button>
      ...
      <button onClick={onClickMyAsyncAwait}>AsyncAwait요청하기 !</button>
    </>
  );
}
