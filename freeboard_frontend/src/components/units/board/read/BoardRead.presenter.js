import { 
    Body, TopWrapper, Top_right, Top_left, Wrapper, Top_Avatar, Top_NameDate, Top_Name, Top_Date, Top_Icon, 
    Body_Title, Body_Image, Body_Text, Body_Video, 
    Footer, Footer_ImgText, Footer_ThumbImg, Footer_YellowText, Footer_GreyText } from '../../../../../styles/check_board'
    ...
    return(
                ...
                <TopWrapper>
                    <Top_left>
                        ...
                        <Top_NameDate>
                            ...
                            {/* 이름받기 */}
                            <Top_Name>{props.data?.fetchBoard.writer}</Top_Name>
        ...
        {/* 게시물 Main */}
                <Body>
                    ...
                    {/* 게시글 내용 받기 */}
                    <Body_Text>{props.data?.fetchBoard.contents}</Body_Text>
